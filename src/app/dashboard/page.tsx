...
export default function Dashboard() {
  ...
  // Usage tracking
  const { trackUsage, isTracking, error: trackingError } = useUsageTracking()
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          {activeTab === 'generate' && (
            <div className="space-y-6">
              {/* Usage Alert - Only show for usage-based plans */}
              {trackingError && planConfig.name === 'Pay Per Image' && (
