    ...
    <>
      ...
      >
        ...
        <p className="mt-6 max-w-2xl text-lg text-gray-700 dark:text-gray-400">
          Flexible pricing for every type of creator. From pay-per-image to unlimited generation, 
          find the perfect plan for your artistic vision.
        </p>
        ...
        <div className="mt-8 rounded-lg border border-lime-200 bg-lime-50 px-4 py-3 dark:border-lime-800 dark:bg-lime-950/30">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-lime-800 dark:text-lime-200">
              Dodo Payments Demo: Three billing models - <strong>Usage-Based</strong>, <strong>One-Time Payment</strong>, and <strong>Subscription</strong>. Try overlay and redirect checkout.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="mx-auto max-w-md">
                ...
                <div className="mt-3 flex items-center gap-x-3">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">
                    per image <br /> {isVariablePrice(plan.price) ? "per month" : ""}
                  </div>
                </div>
