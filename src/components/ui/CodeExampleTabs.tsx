...
export default function CodeExampleTabs({
  ...
  return (
    ...
    >
      ...
      >
        <Tabs.Trigger
          className="group relative flex flex-1 flex-col items-start justify-start rounded-xl p-6 text-left shadow-lg ring-1 ring-gray-200 dark:ring-white/5 dark:data-[state=active]:shadow-lime-900/30"
          value="tab1"
        >
          ...
          <div className="flex items-center gap-4">
            <div className="aspect-square w-fit rounded-lg bg-white p-2 text-gray-700 ring-1 ring-black/10 transition-all group-data-[state=active]:text-lime-600 group-data-[state=active]:shadow-md group-data-[state=active]:shadow-lime-500/20 dark:bg-gray-950 dark:text-gray-400 dark:ring-white/10 dark:group-data-[state=active]:text-lime-400 dark:group-data-[state=active]:shadow-lime-600/50">
              <RiShapesLine aria-hidden="true" className="size-5" />
            </div>
            <p className="font-semibold tracking-tight text-gray-700 transition-all group-data-[state=active]:text-lime-600 sm:text-lg dark:text-gray-400 dark:group-data-[state=active]:text-lime-400">
              Model everything
            </p>
          </div>
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <div className="data-state aspect-square w-fit rounded-lg bg-white p-2 text-gray-700 ring-1 ring-black/10 transition-all group-data-[state=active]:text-lime-600 group-data-[state=active]:shadow-md group-data-[state=active]:shadow-lime-500/20 dark:bg-gray-950 dark:text-gray-400 dark:ring-white/10 dark:group-data-[state=active]:text-lime-400 dark:group-data-[state=active]:shadow-lime-600/50">
