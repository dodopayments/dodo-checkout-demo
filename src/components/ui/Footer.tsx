...
const navigation = {
  product: [
    ...
    { name: "Documentation", href: "https://docs.dodopayments.com/?utm_source=kalash", external: true },
    { name: "API Reference", href: "https://docs.dodopayments.com/api-reference/introduction?utm_source=kalash", external: true },
  ],
  resources: [
  ...
  legal: [
    { name: "Privacy Policy", href: "https://dodopayments.com/privacy-policy?utm_source=kalash", external: true },
    { name: "Terms of Service", href: "https://dodopayments.com/terms-of-use?utm_source=kalash", external: true },
  ],
}
      ...
      <div className="mx-auto max-w-6xl px-3 pb-8 pt-16 sm:pt-24 lg:pt-32">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-gray-200 pt-8 sm:mt-20 sm:flex-row lg:mt-24 dark:border-gray-800">
          <p className="text-sm leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Dodo Payments Demo. Powered by{" "}
            <a 
              href="https://dodopayments.com?utm_source=kalash" 
              target="_blank" 
