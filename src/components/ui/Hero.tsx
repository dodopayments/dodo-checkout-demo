...
export default function Hero() {
  return (
    ...
    >
      <h1
        id="hero-title"
        className="inline-block animate-slide-up-fade bg-gradient-to-br from-gray-900 to-gray-800 bg-clip-text p-2 text-4xl font-bold tracking-tighter text-transparent sm:text-6xl md:text-7xl dark:from-gray-50 dark:to-gray-300 pt-20"
        style={{ animationDuration: "700ms" }}
      >
        From prompt to art in seconds
      </h1>
      <p
        className="mt-6 max-w-lg animate-slide-up-fade text-lg text-gray-700 dark:text-gray-400"
        style={{ animationDuration: "900ms" }}
      >
        Pay per image. Upgrade for more credits, styles, and speed.
      </p>
      <div
      ...
      >
        <Button className="h-10 font-semibold">
          <Link href="/pricing">Start generating</Link>
        </Button>
        <Button
          asChild
          variant="light"
        ...
        >
          <Link
            href="https://www.youtube.com/watch?v=QRZ_l7cVzzU&utm_source=kalash"
